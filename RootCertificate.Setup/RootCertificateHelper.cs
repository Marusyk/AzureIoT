...
namespace RootCertificate.Setup
{
    public class RootCertificateHelper
    {
        ...
        public RootCertificateHelper(string vaultName, string rootCertificateName, string accessToken)
        {
            _vaultBaseUrl = $"https://{vaultName.ToLowerInvariant()}.vault.azure.net/";
            _certificateName = rootCertificateName;
